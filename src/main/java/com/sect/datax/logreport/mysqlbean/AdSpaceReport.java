...
public class AdSpaceReport extends BaseBean {
    private long pkid;//����id
    private String date;//����
    private long ad_space_id;//���λid
    private String ad_space_host;//���λhost
    private long request_num;//�����������
    private long response_num;//��Ӧ����
    private long show_num;//չʾ����
    private long click_num;//�������
    private double total_money;// ���۽��
    private double count_money; //�ɽ����
    ...
    /**
     * @return the ad_space_id
     */
    public long getAd_space_id() {
        return ad_space_id;
    }


    /**
     * @param ad_space_id the ad_space_id to set
     */
    public void setAd_space_id(long ad_space_id) {
        this.ad_space_id = ad_space_id;
    }


    /**
     * @return the ad_space_host
     */
    public String getAd_space_host() {
        return ad_space_host;
    }


    /**
     * @param ad_space_host the ad_space_host to set
     */
    public void setAd_space_host(String ad_space_host) {
        this.ad_space_host = ad_space_host;
    }
