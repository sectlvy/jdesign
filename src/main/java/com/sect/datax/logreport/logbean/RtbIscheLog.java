...
public class RtbIscheLog {
    ...
    private String union_type	;//投放联盟	String	0:代理商 (默认)1:tanx 2:google
    private String bid		;//竞价ID	String	唯一标识的竞价ID
    private String rtb_id	;//rtb cookieid	String	rtb对用户的唯一标识
    private String agency_cookie;//	代理商 cookieid	String	代理商的cookieid（应答日志置空）
    private String User_id	;//用户ID	String	来自于运营商数据的UID
    private String  cash_min	;//cash_min	int(10)	最低竞标价格
    private String  cash_res	;//cash_res	int(10)	出价金额
    private String cash_value	;//cash_value	String	成交金额（应答日志0）
    private String adp_id	;//广告位id	String	
    private String  Adp_url	;//广告位url		
    ...
    private String user_agent	;//user agent	String	
    private String  execut_id	;//策略id	String	
     ...
     * @return the adp_url
     */
    public String getAdp_url() {
        return Adp_url;
    }
    /**
     * @param adp_url the adp_url to set
     */
    public void setAdp_url(String adp_url) {
        Adp_url = adp_url;
    }
    /**
     * @return the ad_id
