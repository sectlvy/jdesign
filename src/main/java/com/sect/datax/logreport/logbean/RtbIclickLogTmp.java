...
public class RtbIclickLogTmp {
    ...
    private String cash_min	;//cash_min	String	最低竞标价格（置0）
    private String cash_res	;//cash_res	String	出价金额（置0）
    private String  cash_value	;//cash_value	String	成交金额（置0）
    ...
    private String  order_id	;//订单id	String	
